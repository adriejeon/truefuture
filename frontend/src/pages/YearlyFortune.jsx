...
function YearlyFortune() {
  ...
  // 결제 완료 후 복귀 처리 (LifetimeFortune과 동일한 로직)
  useEffect(() => {
  ...
  }, [selectedProfile?.id, isSharedFortune, user, searchParams, handleConfirmStarUsageLifetime]);
  ...
  // 주문 확인 모달에서 결제 진행 (LifetimeFortune과 동일한 로직)
