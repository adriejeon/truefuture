...
const FAQ_ITEMS = [
  {
    title:
      "일반적인 '별자리 운세'와 '진짜미래의 정통 점성술 컨설팅'은 무엇이 다른가요?",
    content:
      "시중의 별자리 운세는 태양이 위치한 별자리 하나만으로 전 세계 인구를 12가지 유형으로 분류하는 단순 가십에 가깝습니다. 반면 진짜미래의 정통 점성술 컨설팅은 태양뿐만 아니라 달, 수성, 금성, 화성, 목성, 토성 등 모든 행성의 위치와 그들 사이의 각도(Aspect), 그리고 출생 시간으로 결정되는 하우스(House) 시스템을 종합적으로 연산합니다. 이는 '기성복'과 '맞춤 정장'의 차이만큼이나 개인별 정밀도에서 극명한 차이를 보입니다.",
  },
  {
    title:
      "정통 고전 점성술 컨설팅과 현대 심리 점성술은 어떤 점이 다른가요?",
    content:
      "현대 점성술이 주로 개인의 성격과 심리적 경향을 분석한다면, 정통 고전 점성술 컨설팅은 실제 천체의 물리적 배치와 고전 기법을 통해 사건의 실질적인 발생 여부와 구체적인 길흉화복을 정교하게 예측하는 데 목적이 있습니다. 진짜미래는 수천 년간 검증된 고전의 원형 그대로를 현대적 알고리즘으로 구현합니다.",
  },
  {
    title:
...
const FAQ_PAGE_DESCRIPTION =
  "정통 고전 점성술 컨설팅과 일반 별자리 운세의 차이점, 진짜미래 서비스 이용 방법 등 궁금해하시는 질문들에 대한 상세한 답변을 확인하세요. 20년 경력의 전문성이 담긴 정밀 컨설팅을 제공합니다.";
