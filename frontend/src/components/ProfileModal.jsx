          ...
          <div>
            <div className="flex items-center gap-2 mb-1.5 sm:mb-2 flex-wrap">
              ...
              >
                ...
                {showTimeTooltip && (
                  <span
                    className="absolute left-1/2 -translate-x-1/2 top-full mt-1.5 px-2.5 py-2 text-xs text-slate-200 bg-slate-800 border border-slate-600 rounded-lg shadow-xl whitespace-normal w-52 text-left z-[10003]"
                    style={{
