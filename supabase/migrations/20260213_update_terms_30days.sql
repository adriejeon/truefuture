-- 이용약관 버전 1.2: 운세권 유효기간 정책 변경 (구매일로부터 30일)
-- 2026년 2월 13일부터 적용
...
<div class="terms-content">
  ...
  3. 이미 사용하여 소멸된 '운세권'이나 이벤트로 받은 '데일리 운세권'은 환불되지 않습니다.</p>

  <h3>제8조 ('운세권'의 유효기간 및 소멸)</h3>
  <p>1. '일반 운세권'의 유효기간은 <strong>구매일로부터 30일</strong>입니다.<br>
  2. 유효기간은 구매 시점 기준으로 계산되며, 각 구매 건마다 별도로 적용됩니다.<br>
