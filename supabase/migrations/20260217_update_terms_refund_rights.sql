-- 이용약관 버전 1.3: 유효기간 결제일 90일(3개월) 명시, 소멸시효 5년 및 만료 교환권 90% 환불 조항 추가
-- 2026년 2월 17일부터 적용
...
<div class="terms-content">
  ...
  3. <strong>"운세권"</strong>이란 서비스 내에서 유료 콘텐츠를 이용하기 위해 사용되는 가상의 데이터(지급수단)를 말하며, 회원이 대금을 지급하고 구입하는 <strong>'일반 운세권'</strong>과 회사가 이벤트 등을 통해 무상으로 지급하는 <strong>'데일리 운세권'</strong>으로 구분됩니다.<br>
  ...
  <h3>제6조 ('운세권'의 구매 및 이용)</h3>
  <p>1. 회원은 신용카드, 휴대폰 결제 등을 통해 '운세권'을 구매합니다.<br>
  2. 유료 콘텐츠 이용 시 명시된 액수(예: 운세권 1장)만큼 차감됩니다.<br>
  3. <strong>'데일리 운세권'이 먼저 차감</strong>되고, 이후 '일반 운세권'이 차감됩니다.</p>
  ...
  3. 이미 사용하여 소멸된 '운세권'이나 이벤트로 받은 '데일리 운세권'은 환불되지 않습니다.<br>
  4. <strong>[유효기간 만료 후 환불]</strong> 구매일로부터 5년 이내에 유효기간이 만료된 '일반 운세권'(교환권)에 대해서는 관련 법령에 따라 <strong>결제금액의 90%</strong>를 환불해 드립니다. 단, 구매일로부터 5년(소멸시효)이 지난 경우에는 환불을 요청할 수 없습니다.</p>

  <h3>제8조 ('운세권'의 유효기간 및 소멸)</h3>
  <p>1. '일반 운세권'의 유효기간은 <strong>결제일로부터 90일(3개월)</strong>입니다. 유효기간이 지난 운세권은 사용할 수 없으며 자동 소멸됩니다.<br>
  2. 유효기간은 결제 시점 기준으로 계산되며, 각 구매 건마다 별도로 적용됩니다.<br>
  3. 본 조항은 <strong>2026년 2월 13일 이후 구매한 건부터 적용</strong>됩니다. 그 이전에 구매한 운세권은 기존 정책이 적용됩니다.<br>
  4. '데일리 운세권'은 별도 고지 기간(기본 3개월) 경과 시 소멸됩니다.<br>
  5. 회원 탈퇴 시 모든 '운세권'은 즉시 소멸됩니다.<br>
