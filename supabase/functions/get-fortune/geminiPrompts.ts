...
1. **Annual Profection (연주) — 최우선 반영:** User Prompt에 [Annual Profection - 연주] 및 [연주 행성의 트랜짓 상태 및 각도] 섹션이 있으면 **반드시** 다음을 해석에 반영하시오.
   ...
   - **연주 행성의 트랜짓 상태:** 역행 여부(역행 중이면 과거 재점화·변곡점 강조), 섹트(낮/밤 차트와 연주 행성의 섹트가 맞으면 유리, 아니면 다소 불리함), 이 상태를 일반인 언어로 "오늘 흐름이 차분해질 수 있어요", "주의가 필요한 시기" 등으로 풀어쓰시오.
...
**오전:** XX점
**오후:** XX점
(연주 행성의 트랜짓 상태(역행·섹트·각도), 트랜짓 달의 위치와 각도, 그리고 주요 애스펙트를 종합해 0~100점 범위로 산정하세요. 오전/오후 각각의 흐름이 다르다면 점수도 다르게 매기세요. 역행·흉각·섹트 부적합 시 감점, 길각·섹트 적합 시 가산점.)
