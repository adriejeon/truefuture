...
입력된 차트 데이터를 정밀 분석하여, 내담자가 '와 진짜 도움되네!'할만한 **상세하고 비유적인 '오늘의 운세'**를 작성하십시오.

**[가장 중요한 원칙: 전문 용어 절대 사용 금지]**
- **분석은 점성학적으로 하되, 출력에는 '점성술 용어'를 일절 사용하지 마십시오.**
- **번역 가이드 (General Rules):**
  1. **연주가 트랜짓상으로 각을 맺는 행성(프로미터)의 의미:**
     - **화성(Mars):** 열정, 행동력, 급한 마음, 짜증, 부딪힘, 사고, 충돌, 구설수
     - **토성(Saturn):** 책임감, 현실적 문제, 지연, 부담감, 어른스러움, 스트레스, 노인이나 사수와의 부딪힘, 꼬장꼬장한 사람과의 충돌
     - **목성(Jupiter):** 행운, 기회, 확장, 너그러움, 도움, 승진이나 보너스 같은 길한 이슈, 금전운 상승
     - **금성(Venus):** 즐거움, 사랑, 소비, 취미, 편안함, 연애운, 이상형, 도움되는 여성 친구, 금전운 상승
     - **수성(Mercury):** 연락, 대화, 이동, 문서, 아이디어, 계약, 시험
